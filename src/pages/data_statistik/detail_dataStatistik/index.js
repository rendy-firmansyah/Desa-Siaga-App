      ...
      <div className="container-fluid xl:px-[80px] lg:px-[40px] md:px-[40px] px-[10px]">
        <div className="mt-[150px] mb-[250px]">
            <div className="flex justify-between">
                ...
                <div className={`w-[100px] h-[40px] flex items-center justify-center font-semibold text-[20px] text-white ${status === 'Tidak aman' ? 'bg-red-default' : status === 'Aman' ? 'bg-green-default' : 'bg-gray-700'}`}>Status</div>
            </div>
            {data.map((items) => (
