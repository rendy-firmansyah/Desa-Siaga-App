                ...
                <div className="w-full bg-white xl:px-[50px] lg:px-[35px] md:px-[25px] px-[15px] xl:py-[50px] lg:py-[35px] md:py-[25px] py-[15px] shadow-lg mt-[35px]">
                        ...
                        <table className="min-w-full divide-y divide-gray-200 border-2 shadow-lg shad">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td className="text-black px-6 py-4 whitespace-nowrap">Kebijakan/Peraturan</td>
                                ...
                                <tr>
                                    ...
                                    <td className="text-black px-6 py-4 whitespace-nowrap">Penguatan Kapasitas</td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap">8</td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap"></td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="text-black px-6 py-4 whitespace-nowrap">Peringatan Dini</td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap">2</td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap"></td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="text-black px-6 py-4 whitespace-nowrap">Mitigasi</td>
                                ...
                                <tr>
                                    ...
                                    <td className="text-black px-6 py-4 whitespace-nowrap">Kesiapsiagaan</td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap">14</td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap"></td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap"></td>
                                </tr>
                                <tr>
                                    <td className="text-black px-6 py-4 whitespace-nowrap" colSpan='2'>Total Pencapaian</td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap">43</td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap"></td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap"></td>
                                </tr>
                                <tr>
                                    <td className="text-black px-6 py-4 whitespace-nowrap" colSpan='2'>Persentase</td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap">100%</td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap"></td>
                                    <td className="text-black px-6 py-4 whitespace-nowrap"></td>
                                </tr>
                            </tbody>
                    ...
                    <div className="my-[20px]">
                        ...
                        <div className="my-[10px]">
                            <div className="text-black font-semibold text-[16px] mb-[10px]">Pengkategorian Tingkat kapasitas Desa adalah sebagai berikut:</div>
                            <div className="text-black font-semibold text-[16px] mb-[10px]">Rendah <span className="ms-[50px] me-[10px]">:</span>pencapaian 1% - 33% dari seluruh indicator</div>
                            <div className="text-black font-semibold text-[16px] mb-[10px]">Sedang <span className="ms-[50px] me-[10px]">:</span>pencapaian 34% - 66% dari seluruh indicator</div>
                            <div className="text-black font-semibold text-[16px] mb-[10px]">Tinggi <span className="ms-[60px] me-[10px]">:</span>pencapaian 67% - 100% dari seluruh indicator</div>
                        </div>
                    </div>
                </div>
